...
<div class="container mt-5">
    ...
    <form action="/mau-sac/store" method="post" class="mb-4">
        <div class="form-group">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
        <c:forEach items="${data}" var="mauSac">
            <tr>
                <td>${mauSac.id}</td>
                <td>${mauSac.ma}</td>
                <td>${mauSac.ten}</td>
                ...
                <td>
                    <a href="/mau-sac/edit/${mauSac.id}" class="btn btn-primary btn-sm">Cập nhật</a>
                    <a href="/mau-sac/delete/${mauSac.id}" class="btn btn-danger btn-sm">Xóa</a>
                    <a href="/mau-sac/detail/${mauSac.id}" class="btn btn-info">Chi tiết</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
    ...
    <div>
        <c:if test="${currentPage > 0}">
            <a href="/mau-sac/index?page=${currentPage - 1}" class="btn btn-secondary">Trang trước</a>
        </c:if>
        <c:if test="${data.size() == 10}">
            <a href="/mau-sac/index?page=${currentPage + 1}" class="btn btn-secondary">Trang sau</a>
        </c:if>
    </div>
</div>
