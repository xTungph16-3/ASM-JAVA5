...
<div class="container mt-5">
    <form action="/hdct/search" method="get">
    ...
    <form action="/hdct/store" method="post" class="mb-4">
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="idHoaDon" name="idHoaDon" value="${data1.idHoaDon}">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="idSP" name="idSP" value="${data1.idSP}">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="soLuong" name="soLuong" value="${data1.soLuong}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="donGia" name="donGia" value="${data1.donGia}">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
        <c:forEach items="${data}" var="hoaDonChiTiet">
            <tr>
                <td>${hoaDonChiTiet.id}</td>
                <td>${hoaDonChiTiet.idHoaDon}</td>
                <td>${hoaDonChiTiet.idSP}</td>
                <td>${hoaDonChiTiet.soLuong}</td>
                <td>${hoaDonChiTiet.donGia}</td>
                <td>${hoaDonChiTiet.trangThai == 1 ? "Hoạt động" : "Không hoạt động"}</td>
                <td>
                    <a href="/hdct/edit/${hoaDonChiTiet.id}" class="btn btn-primary">Cập nhật</a>
                    <a href="/hdct/delete/${hoaDonChiTiet.id}" class="btn btn-danger">Xóa</a>
                    <a href="/hdct/detail/${hoaDonChiTiet.id}" class="btn btn-info">Chi tiết</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
    ...
    <div>
        <c:if test="${currentPage > 0}">
            <a href="/hdct/index?page=${currentPage - 1}" class="btn btn-secondary">Trang trước</a>
        </c:if>
        <c:if test="${currentPage < totalPages - 1}">
            <a href="/hdct/index?page=${currentPage + 1}" class="btn btn-secondary">Trang sau</a>
        </c:if>
    </div>
</div>
